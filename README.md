...
1. Create your new DAG name ```{user}_dag_v2.py``` and add code from add code from [phawatmk_dag.py](https://github.com/phawatmk/airflow_training/blob/main/phawatmk_dag.py)
